...
import 'materialform_model.dart';
export 'materialform_model.dart';
...
class MaterialformWidget extends StatefulWidget {
  ...
  final MaterialInventoryRecord? materialRef;
...
class _MaterialformWidgetState extends State<MaterialformWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MaterialformModel());
    ...
    _model.unidadTextController ??= TextEditingController();
    _model.unidadFocusNode ??= FocusNode();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Nombre de la materia prima',
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: _model.cantidadTextControllerValidator
                        .asValidator(context),
                  ),
                ),
                Row(
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.proveedorTextController,
                          ...
                          validator: _model.proveedorTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    Expanded(
                      ...
                      child: Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 12.0),
                        child: TextFormField(
                          controller: _model.unidadTextController,
                          focusNode: _model.unidadFocusNode,
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                          ...
                          validator: _model.unidadTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                        ...
                        StreamBuilder<List<MaterialInventoryRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FFButtonWidget(
                              onPressed: () async {
                                await actions.manageMaterialInventory(
                                  ...
                                  _model.datePicked!,
                                  _model.proveedorTextController.text,
                                  _model.unidadTextController.text,
                                  _model.subirImagenModel.uploadedFileUrl,
                                );
                                setState(() {
                                  _model.productnameTextController?.clear();
                                  _model.cantidadTextController?.clear();
                                  _model.proveedorTextController?.clear();
                                  _model.precioTextController?.clear();
                                  _model.unidadTextController?.clear();
                                });

                                context.pushNamed('mainMaterialManager');
                              },
                              text: 'Registrar',
