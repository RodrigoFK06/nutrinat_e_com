...
import 'pay_card_model.dart';
export 'pay_card_model.dart';
...
class _PayCardWidgetState extends State<PayCardWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PayCardModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if ((_model.apiResultlnn?.succeeded ?? true)) {
                        ...
                        setState(() {});
                        _model.uuidOut = await UuidCall.call();

                        FFAppState().UUID4 = getJsonField(
                          (_model.uuidOut?.jsonBody ?? ''),
                          r'''$''',
                        ).toString();
                        setState(() {});
                        _model.apiResultgu3 = await PayCardCall.call(
                          accessToken:
                              'APP_USR-4841127657432332-060819-fb5ac35608a79a8a206777b0c183efd0-1848213391',
                          transactionAmount: 1400.0,
                          token: FFAppState().IdCard,
                          firstName: 'Rodrigo',
                          lastName: 'Torres',
                          email: 'clanprotm4@gmail.com',
                          identificationType: 'DNI',
                          identificationNumber: '75893674',
                          zipCode: '13001',
                          streetName: 'C.29',
                          streetNumber: '29',
                          ...
                          federalUnit: '1234',
                          description: 'Bleh',
                          idempotencyKey: FFAppState().UUID4,
                        );

                        if ((_model.apiResultgu3?.succeeded ?? true)) {
